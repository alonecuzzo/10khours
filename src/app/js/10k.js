...
$(function() {
    ...
    var ChartView = Backbone.View.extend({
        ...
        render: function() {
            ...
            $element.find('#next-week-arrow').on('click', {
                view: this
