...
$(function() {
    ...
    var ChartView = Backbone.View.extend({
        ...
        render: function() {
            ...
            var labelDiv = '<div id="chart-label-div"><div id="chart-header"><div id="previous-week-arrow"><button class="btn" id="previous-week-arrow-btn"><i class="icon-arrow-left previous-week-arrow-icon"></i></button></div>Week of ' + firstDayOfWeek.toString('MM/dd/yy') + '<div id="next-week-arrow"><button id="next-week-arrow-btn" class="btn"><i class="icon-arrow-right next-week-arrow-icon"></i></button></div></div><div id="chart-date-label-container"><div id="chart-date-monday" class="chart-date-label"><span>Mon <div class="chart-full-date-label">' + firstDayOfWeek.toString('MM/dd') + '</div><div class="badge badge-info">' + formatHours(sessionsWeekTotals[0], true) + '</div></span></div><div id="chart-date-tuesday" class="chart-date-label inline-label"><span>Tue <div class="chart-full-date-label">' + firstDayOfWeek.add(1).days().toString('MM/dd') + '</div><div class="badge badge-info">' + formatHours(sessionsWeekTotals[1], true) + '</div></span></div><div id="chart-date-wednesday" class="chart-date-label inline-label"><span>Wed <div class="chart-full-date-label">' + firstDayOfWeek.add(1).days().toString('MM/dd') + '</div><div class="badge badge-info">' + formatHours(sessionsWeekTotals[2], true) + '</div></span></div><div id="chart-date-thursday" class="chart-date-label inline-label"><span>Thu <div class="chart-full-date-label">' + firstDayOfWeek.add(1).days().toString('MM/dd') + '</div><div class="badge badge-info">' + formatHours(sessionsWeekTotals[3], true) + '</div></span></div><div id="chart-date-friday" class="chart-date-label inline-label"><span>Fri <div class="chart-full-date-label">' + firstDayOfWeek.add(1).days().toString('MM/dd') + '</div><div class="badge badge-info">' + formatHours(sessionsWeekTotals[4], true) + '</div></span></div><div id="chart-date-saturday" class="chart-date-label inline-label"><span>Sat <div class="chart-full-date-label">' + firstDayOfWeek.add(1).days().toString('MM/dd') + '</div><div class="badge badge-info">' + formatHours(sessionsWeekTotals[5], true) + '</div></span></div><div id="chart-date-sunday" class="chart-date-label inline-label"><span>Sun <div class="chart-full-date-label">' + firstDayOfWeek.add(1).days().toString('MM/dd') + '</div><div class="badge badge-info">' + formatHours(sessionsWeekTotals[6], true) + '</div></span></div></div><div id="chart-footer"></div></div>';
            firstDayOfWeek.add(-6).days();
            ...
            $element.find('#previous-week-arrow-btn').on('click', {
                view: this
            }, this.onPreviousWeekClick);
            $element.find('#next-week-arrow-btn').on('click', {
                view: this
